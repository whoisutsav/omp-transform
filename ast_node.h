...
enum ASTNodeType { UNOP, BINOP, VAR, CONSTANT, STR_CONSTANT, IF_STMT, FOR_STMT, ASSIGN_EXP, EXP_STMT, BLK_STMT, RET_STMT, VDECL, OMPN_PARALLEL, OMPN_SINGLE, OMPN_CRITICAL, OMPN_MASTER, OMPN_FOR };
